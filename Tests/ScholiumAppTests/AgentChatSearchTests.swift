...
struct AgentChatSearchTests {
    ...
    func publicContent() {
        ...
        planMessage.plan = .init(
            turnID: "turn", explanation: "比较解释",
    ...
    func navigation() {
        var messages = [
            AgentChatMessage(id: "a", role: .user, text: "理由 理由"),
    ...
    func nativeCommands() {
        ...
        editor.setMarkedText(
            "候选", selectedRange: NSRange(location: 2, length: 0),
