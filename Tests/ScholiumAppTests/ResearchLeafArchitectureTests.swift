...
struct ResearchLeafArchitectureTests {
    ...
    func researchLeavesDoNotBorrowWindowModel() throws {
        ...
        #expect(overview.contains("let openZoteroItem: (String) async -> Void"))
    ...
    func researchRootWiringIsExplicit() throws {
        ...
        #expect(content.contains("zoteroItemKey: currentAnalysisZoteroItemKey"))
        ...
        #expect(content.contains("openZoteroItem: { itemKey in"))
