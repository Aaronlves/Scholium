...
private actor ChildReadFixture {
    ...
    func request(_ method: String, _ params: [String: MCPJSONValue]) throws -> MCPJSONValue {
        ...
        func turn(_ id: String) -> MCPJSONValue {
            .object([
                "id": .string(id), "status": .string(id == "active" ? "inProgress" : "completed"),
                "itemsView": .string(summary ? "summary" : "full"),
                "items": .array([
        ...
        if method == "thread/turns/list" {
            return .object([
                "data": .array(params["cursor"] == nil ? [turn("active"), turn("recent")] : [turn("earlier")]),
