...
struct CodexChatMethodsTests {
  ...
  func methods() throws {
    ...
    let result: MCPJSONValue = .object(["data": .array([.object([
  ...
  @Test("Installed Codex discovers and toggles an isolated local method without inference",
  ...
  func officialMethods() async throws {
    ...
    do {
      ...
      _ = try await runtime.request("initialize", params: ["clientInfo": .object([
