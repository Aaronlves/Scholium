...
struct CodexChatDelegationTests {
  ...
  func projection() throws {
    var item: [String: MCPJSONValue] = ["type": .string("collabAgentToolCall"),
      ...
      "prompt": .string("Compare only the supplied passages."), "agentsStates": .object([
  ...
  func lifecycle() throws {
    var item: [String: MCPJSONValue] = ["type": .string("subAgentActivity"),
