...
struct CLIApplicationDelegationTests {
    ...
    func commandFamiliesUseApplicationCapabilities() throws {
        ...
        #expect(sources.workspace.contains("research.discussionRecords()"))
        #expect(sources.entry.contains(#"case "comment":"#))
        #expect(sources.workspace.contains("handle.research.commentExchange(id: id)"))
        #expect(sources.workspace.contains("handle.research.appendCommentExchangeTurn("))
