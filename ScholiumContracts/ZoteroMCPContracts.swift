...
public enum ZoteroMCPCapability: String, Codable, CaseIterable, Hashable, Sendable {
    ...
    case bibtexExport = "bibtex-export"
    case citations
    case importRecords = "import-records"
    case itemModification = "item-modification"
}
...
/// The first-party transport that Scholium exposes to an external agent.
/// Zotero remains the sole library authority; Scholium only brokers the
/// documented local API and Connector surfaces.
public struct ZoteroMCPTransportDescriptor: Codable, Hashable, Sendable {
    ...
    public static let supportedLocal = Self(
        ...
        displayName: "Scholium Zotero connection",
