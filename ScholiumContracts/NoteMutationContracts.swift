...
/// Immutable authority captured when a researcher invokes an
/// identity-dependent mutation from a concrete Note projection. The
/// vault-qualified location, stable identity, and exact source revision travel
/// together so a reused path cannot retarget a stale interface command.
public struct NoteMutationTarget: Codable, Hashable, Identifiable, Sendable {
