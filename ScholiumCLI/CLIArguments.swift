...
extension ScholiumCLI {
    ...
    private static let commandRules: [String: CLICommandRule] = {
        ...
        var rules: [String: CLICommandRule] = [
            ...
            "bibliography show": .init(pathLength: 2, positionalCount: 1 ... 1, options: selected),
            "bibliography complete": .init(pathLength: 2, options: ["--from": .value, "--triptych": .value, "--format": .value]),
            "bibliography cancel": .init(pathLength: 2, positionalCount: 1 ... 1, options: selected),
