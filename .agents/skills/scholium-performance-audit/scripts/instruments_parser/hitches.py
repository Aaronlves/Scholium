...
The `hitches` schema commonly includes start, duration (hitch time), process,
is-system, swap-id, label, display, and narrative-description. The
...
def analyze(
    ...
    for row in stream:
        ...
        events.append({
            ...
            "hitch_duration_ns": duration_ns,  # selected schema duration as hitch time
