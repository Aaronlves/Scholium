...
- Evidence obtained: decision / fixture comparison / optional shadow / cutover
...
For claimed performance, record only relevant metrics with build, units, sample
count, and sampling policy. Mark required but unmeasured values explicitly;
do not substitute an engine microbenchmark for a complete product boundary.
