...
- Use menu-item icons **sparingly and with purpose**: highlight the most common actions, key features, locations, connected devices, clear visual operations, or user-created folders and documents.
