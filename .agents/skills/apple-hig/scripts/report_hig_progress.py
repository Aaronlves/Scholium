...
def main() -> int:
    ...
    inventory = args.inventory if args.inventory.is_absolute() else SKILL_ROOT / args.inventory
    ...
    tiers = distilled_tiers(distilled_dir)
    ...
    for record in records:
        ...
        tier_path = SKILL_ROOT / str(distilled_file) if distilled_file else None
        tier = tiers.get(tier_path.as_posix()) if tier_path else None
        if tier:
