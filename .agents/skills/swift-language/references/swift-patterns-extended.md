...
production decoding architecture to the live API contract, project-specific
guidance, and official Codable documentation. Do not assume a dedicated skill is
installed.
...
For richer reusable style design, parsing, and locale-sensitive formatting,
inspect project localization guidance, test a representative locale matrix, and
consult official FormatStyle documentation. Do not assume a dedicated skill is
installed.
