        ...
        Group {
            ...
            case .note(let coverage):
                DisclosureGroup(isExpanded: $isExpanded) {
                    ...
                    if !coverage.coversCitedLine {
                        Text("Cited location not read")
                    } else if coverage.coversWholeSource {
                        Text("Full source received")
                    } else if coverage.ranges.isEmpty {
                        Text("No source text returned")
                    } else {
                        Text("Read lines \(coverage.lineDescription)")
                    }
                }
            }
        }
