...
(() => {
  ...
  // math-runtime.ts
  var maximumSourceLength = 16384;
  function renderMath(request) {
    if (request.kind !== "inline" && request.kind !== "display" || typeof request.source !== "string" || request.source.length === 0 || request.source.length > maximumSourceLength) {
  ...
  var scholiumMathRuntime = Object.freeze({
    version: 1,
    render: renderMath
  });
