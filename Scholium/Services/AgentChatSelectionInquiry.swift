...
struct AgentChatSelectionInquiry: Equatable, Sendable {
  ...
  static var explain: Self { .init(title: ScholiumL10n.string("Explain"), question:
    ScholiumL10n.string("Explain the attached passage concisely. Distinguish its explicit claims from your interpretation, and identify uncertainty where context is missing. Do not change Notes.")) }
  static var polish: Self { .init(title: ScholiumL10n.string("Polish"), question:
    ScholiumL10n.string("Polish the attached passage while preserving its thesis, terminology, qualifications, citations and Markdown structure. Return only the proposed replacement Markdown, without a code fence or introductory explanation. Do not change Notes."), resultKind: .replacement) }
  static var clarifyConcepts: Self { .init(title: ScholiumL10n.string("Clarify Concepts"), question:
  ...
  static var examineArgument: Self { .init(title: ScholiumL10n.string("Examine Argument"), question:
  ...
  static var checkEvidence: Self { .init(title: ScholiumL10n.string("Check Evidence"), question:
