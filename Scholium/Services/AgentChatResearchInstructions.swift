...
enum AgentChatResearchInstructions {
  static func developer(triptychID: UUID) -> String {
    ...
    This is a research conversation, not maintenance of the Scholium application. Use the provided Scholium Core Protocol and Skills chosen by the researcher. Do not discover or read application-development skills, repository AGENTS.md, implementation specifications or source code merely to use the research tools. Do not narrate routine tool mechanics or append technical compliance reports to ordinary research answers.
