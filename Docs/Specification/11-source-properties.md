...
owns the Note title; app-owned stable identity remains separate. Authored `title`, `aliases`, `authors`/`author`, and
...
Nested mappings remain authored data; Scholium does not infer creator
