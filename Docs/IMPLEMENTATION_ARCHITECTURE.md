...
| [Source Layout, Presentation, and Shared Boundaries](Architecture/03-source-layout-and-presentation.md) | Repository source layout, native presentation composition, Settings and integrations, shared primitives, window routes, Attention, Research Inspector, localization, and boundary checks. |
