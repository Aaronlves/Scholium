...
**当前 Core App Beta：**[v0.2.2-beta](https://github.com/Aaronlves/Scholium/releases/tag/v0.2.2-beta) ·
[下载 Apple 芯片版 Scholium](https://github.com/Aaronlves/Scholium/releases/download/v0.2.2-beta/Scholium-v0.2.2-beta-macos-arm64.dmg)
