...
description: Critique an exact Work or passage as an attributed, read-only scholarly assessment that separates exposition, argument, objection, reply, and researcher commitment. Use for the Critique Action; never revise the Work in the same phase.
---
...
Read `references/method.md`. For whole-Work scope, examine strengths,
weaknesses, method fit, source coverage, sustained argument, contribution
burdens, omissions, objections, alternatives, implications, and priorities.
For passage scope, identify the exact target, issue, significance, research
...
field completeness, or researcher competence.
