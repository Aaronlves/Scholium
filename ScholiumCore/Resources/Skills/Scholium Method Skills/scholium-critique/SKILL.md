...
Read `references/method.md`. For whole-Work scope, examine strengths, weaknesses, source coverage, omissions, objections, alternatives, and priorities. For passage scope, identify the exact target, issue, significance, research basis, and recommendation without issuing an unsupported verdict on the whole Work.
