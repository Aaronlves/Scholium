---
name: scholium-write
description: Draft or revise the current Work while preserving researcher authority, explicit source roles, and the smallest authorized scope. Use only for the Write Action on a Work Target, including separately authorized changes arising from Critique or feedback.
---
