...
public struct WindowSessionSnapshot: Codable, Hashable, Sendable {
    ...
    public var selectedCanvasID: UUID?
    public var showsCanvas: Bool?
    ...
    public init(
        ...
        selectedCanvasID: UUID? = nil,
        showsCanvas: Bool? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            selectedCanvasID: try container.decodeIfPresent(UUID.self, forKey: .selectedCanvasID),
            showsCanvas: try container.decodeIfPresent(Bool.self, forKey: .showsCanvas),
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(selectedCanvasID, forKey: .selectedCanvasID)
        try container.encodeIfPresent(showsCanvas, forKey: .showsCanvas)
...
/// Persists window presentation state under Application Support.
